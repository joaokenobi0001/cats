import { useState } from 'react'; // Importando apenas o que é necessário
import { useNavigate } from 'react-router-dom'; 
import { recuperar_senha, verificar_senha } from '../api/user'; // Corrigido para importar as funções corretas
